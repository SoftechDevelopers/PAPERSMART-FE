...
// ** Configs
import TemplateNameComponent from 'src/@core/components/custom-components/TemplateNameComponent'
...
const VerticalNavHeader = props => {
  ...
  const logo = '/images/icons/project-icons/title-logo.png'
  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <img alt='logo' src={logo} style={{ width: '32px', height: '32px' }} />
          <HeaderTitle variant='h6' sx={{ ...menuCollapsedStyles, ...(navCollapsed && !navHover ? {} : { ml: 2 }) }}>
            <TemplateNameComponent mode={mode} />
          </HeaderTitle>
        </LinkStyled>
      )}
